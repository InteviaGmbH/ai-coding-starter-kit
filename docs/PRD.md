...
| P0 (MVP) | Einfache Vertragsgenerierung (generiertes Dokument, Unterschrift als Upload) | Planned — Spec: [PROJ-10](../features/PROJ-10-einfache-vertragsgenerierung.md) |
