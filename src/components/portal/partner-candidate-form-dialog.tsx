...
import { createPartnerCandidate, updatePartnerCandidate } from "@/app/partner/candidates/actions"
...
export interface PartnerCandidateFormDialogProps {
  mode: "create" | "edit"
  candidateId?: string
...
export function PartnerCandidateFormDialog({
  mode,
  candidateId,
  defaultValues,
  trigger,
}: PartnerCandidateFormDialogProps) {
  ...
  async function onSubmit(values: FormValues) {
    ...
    const result =
      mode === "create"
        ? await createPartnerCandidate(values)
        : await updatePartnerCandidate(candidateId!, values)
